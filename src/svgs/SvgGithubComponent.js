export default function SvgGithubComponent({
    width, height, color, display
}) {

    return (
        <svg width={width} height={height} viewBox="0 0 20 20" role="img" xmlns="http://www.w3.org/2000/svg" style={{display}}>
            <path
      style={{fill: color}}
...
SvgGithubComponent.defaultProps = {
    display: 'block',
    width: '25px',
    height: '25px'
}